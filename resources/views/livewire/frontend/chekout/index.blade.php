                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">Rp. {{ $this->totalAmount }}</span>
                        </h4>
                        <hr>
                    ...
                    <div class="shadow bg-white p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" wire:model.defer="pincode"
                                ...
                                <div class="d-md-flex align-items-start">
                                    ...
                                    <div class="tab-content col-md-9" id="v-pills-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="onlinePayment" role="tabpanel"
                                            ...
                                            <hr />
                                            <button type="button" wire:click='transaksi' class="btn btn-warning">Pay
                                                Now (Online
                                                Payment)</button>
                                        </div>
                                    </div>
